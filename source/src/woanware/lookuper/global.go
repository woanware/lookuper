...
const (
	...
	dataTypeMd5All 		= 7
	dataTypeStringTe 	= 8
	dataTypeGsb 		= 9 // Google SafeBrowsing
)
...
var dataTypes = []string{
	...
	dataTypeMd5All: "MD5 (All)",
	dataTypeStringTe: "String (TE)",
	dataTypeGsb: "Google Safe Browsing",
}

// Response codes for use in the "work" table
const WORK_RESPONSE_NOT_PERFORMED int8 = 100
const WORK_RESPONSE_ERROR int8 = 99
const WORK_RESPONSE_OK int8 = 1
const WORK_RESPONSE_KEY_FAILED int8 = -128
